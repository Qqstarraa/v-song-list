...
import avatarImage from './assets/achuan.jpg';
import pixelImage from './assets/bchuan.png';
import './App.css';
                ...
                <Drawer visible={visable} onClose={closeDrawer} size={"default"}>
                    <Row justify={"center"}>
                        <Col span={24} style={{fontSize: '18px', marginBottom: '20px'}}>
                            <div style={{fontSize: '24px'}}>~这里要填什么~</div>
                            <div>大家好，这里是<span
                                style={{
                                    color: "#d58a98",
                                    fontSize: '20px',
                    ...
                    >
                        <Button className={'BtnBiliSpace'}
                                onClick={() => window.open("https://space.bilibili.com/2149324")}>
                        ...
                        <Button className={'BtnBiliLive'}
                                onClick={() => window.open("http://live.bilibili.com/8526397")}>
                            <div className={'BtnContent'}>
